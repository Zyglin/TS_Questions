...
| 12 | [Перегрузка функций (Function Overloads)](#перегрузка-функций-function-overload-1) |
| 13 | [Интерфейс объекта (Object Interface)](#интерфейс-объекта-interface) |
| 14 | [Модификаторы частей объекта ? и readonly](#модификаторы-частей-объекта--и-readonly) |
| 15 | [Доступ к частям объектного типа](#доступ-к-частям-объектного-типа) |
| 16 | [Интерфейс функционального объекта](#интерфейс-словаря-dictionary-interface) |
| 17 | [Интерфейс словаря и Array-Like объекта](#array-like-объект) |
| 18 | [Тип-перечисление enum и const enum](#тип-перечисление-enum) |
| 19 | [Объединение нескольких enum](#объединение-нескольких-enum) |
| 20 | [Кортежи (Tuples)](#кортежи-tuples) |
| 21 | [Модификатор readonly](#модификатор-readonly) |
| 22 | [Наследование и объединение интерфейсов](#наследование-и-объединение-интерфейсов) |
| 23 | [Полиморфизм подтипов](#полиморфизм-подтипов-subtype-polymorphism) |
| 24 | [Класс объекта в TypeScript](#класс-объекта-object-class) |
| 25 | [Объединение типов (Union Types)](#объединение-типов-union-types) |
| 26 | [Специальный тип never](#специальный-тип-never) |
| 27 | [Разница между interface и type](#разница-между-interface-и-type) |
| 28 | [Модификатор override](#модификатор-override) |
| 29 | [Модификатор accessor](#модификатор-accessor) |
| 30 | [Оператор satisfies](#оператор-satisfies) |
| 31 | [Небезопасные приведения типов](#небезопасные-приведения-типов-unsafe-type-assertions) |
| 32 | [Проблемные приведения типов](#проблемные-приведения-типов-problematic-type-assertions) |
| 33 | [Декораторы классов](#декораторы-классов-class-decorators) |
| 34 | [Декораторы методов класса](#декораторы-методов-класса-method-decorators) |
| 35 | [Декораторы свойств класса](#декораторы-свойств-класса-property-decorators) |
| 36 | [Агрегация метаинформации](#агрегация-метаинформации-metadata-aggregation) |
| 37 | [Декораторы статических частей класса](#декораторы-статических-частей-класса) |
| 38 | [Глобальные типы и формат .d.ts](#глобальные-типы-и-формат-dts) |
| 39 | [Оператор declare](#оператор-declare) |
| 40 | [Расширение globalThis](#расширение-globalthis) |
| 41 | [Типизация JavaScript-модуля на TypeScript](#типизация-модуля-на-javascript) |
| 42 | [Разбиение одного .d.ts на множество файлов](#разбиение-одного-dts-на-множество-файлов) |
| 43 | [Сборка TypeScript с генерацией .d.ts типов](#сборка-typescript-с-генерацией-dts-типов) |
| 44 | [tsc и tsc-cli](#tsc) |
...
Перегрузка функций — это возможность описать несколько вариантов вызова одной функции с разными типами параметров и возвращаемых значений.

Используется, когда функция может работать с разными типами данных.

---

## Синтаксис

Перегрузки описываются перед основной реализацией:
...
TypeScript не знает точный тип результата:
...
## Пример с разным количеством параметров
